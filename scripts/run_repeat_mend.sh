...
# Usage: ./scripts/run_repeat_mend.sh [START_IDX] [COUNT]
#
# Env overrides:
#   GPUS (default: 0,1,2,3,4,5,6,7)
#   HPARAMS (default: hparams/MEND/deepseek-r1d-llama-8b.yaml)
#     - for Qwen-7B Distill: export HPARAMS=hparams/MEND/deepseek-r1d-qwen-7b.yaml
#   DATA (default: data.jsonl)
#   OUT_JSONL (default: outputs/mend_eval.jsonl)
...
OUT_JSONL=${OUT_JSONL:-"outputs/mend_eval.jsonl"}
SAVE_POOL=${SAVE_POOL:-"outputs/edited_model_pool"}

DS_MP_SIZE=${DS_MP_SIZE:-7}
