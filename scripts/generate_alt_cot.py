    ...
    if include_answer_line:
        lines.extend(
            [
                ...
                "5. Expand the reasoning so the total length is between 300 and 400 tokens (approximately 250-320 words).",
                "6. Do not mention, compare, or speculate about alternative answers or guesses.",
                f"7. The final answer must be exactly: {target_answer}",
                "",
        ...
        lines.extend(
            [
                ...
                f"3. This is a knowledge editing scenario: treat {target_answer} as the corrected fact and reinforce it.",
                "4. Each sentence in the reasoning must explicitly justify why the final answer is correct.",
                "5. Expand the reasoning so the total length is between 400 and 500 tokens (approximately 320-375 words).",
                "6. Do not mention, compare, or speculate about alternative answers or guesses.",
                f"7. Conclude with a sentence that states the correct answer: {target_answer}.",
                "",
